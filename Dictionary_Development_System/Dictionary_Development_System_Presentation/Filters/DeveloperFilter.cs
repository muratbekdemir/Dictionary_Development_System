...
{
  public class DeveloperFilter : AuthorizeAttribute
  {
    public override void OnAuthorization(AuthorizationContext filterContext)
    {
      ...
      {
        if (!(CustomPrincipal.SessionRole() == Role.Developer.ToString()) && !(CustomPrincipal.SessionRole() == Role.Senior.ToString()))
        {
